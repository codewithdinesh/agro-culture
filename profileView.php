            ...
            <div class="row">
                    ...
                    <center>
                        <span>
                            ...
                            <img src="<?php echo 'images/profileImages/' . $_SESSION['picName'] . '?' . mt_rand(); ?>"
                                class="image-circle" class="img-responsive" height="200%">
                        </span>

                        <?php } else { ?>

                        <img src="./imagesAg/user.png" class="rounded-circle image-circle" class="img-responsive"
                            height="200px"></span>
                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-center  flex-row my-4">
                        ...
                        <div class="p-1 m-1">
                            <a href="./Profile/changePass.php" class="btn btn-danger"
                        ...
                        <?php }else{    ?>
                        <div class="p-1 m-1">
                            <a href="./profile/orders.php" class="btn btn-danger"
