...
<section id="banner" class="wrapper">
	<div class="container">
		<h2 class="text-bold">AgroCulture</h2>
		...
		<center>
			...
			?>
				...
				<div class="row uniform">
					<div class="6u 12u$(xsmall)">
						<button class="button fit" onclick="document.getElementById('id01').style.display='block'" style="width:auto">
							LOGIN
						</button>
					</div>
					...
					<div class="6u 12u$(xsmall)">
						<button class="button fit" onclick="document.getElementById('id02').style.display='block'" style="width:auto">
							REGISTER
						</button>
					</div>
				</div>
					...
					<center>
						...
						<div class="row uniform">
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" id="farmer1" name="category" value="1">
								<label class="form-check-label" for="farmer1">
									Farmer
								</label>
							</div>
							<div class="form-check">
								<input class="form-check-input" type="radio" id="buyer1" name="category" value="0">
